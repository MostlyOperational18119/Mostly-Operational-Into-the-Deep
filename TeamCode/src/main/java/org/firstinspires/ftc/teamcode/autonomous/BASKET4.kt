...
class BASKET4 : Methods() {
    override fun runOpMode() {
        ...
        drive!!.poseEstimate = Pose2d(-8.7, -63.19, Math.toRadians(180.00))

        val basket0: TrajectorySequence =
            drive!!.trajectorySequenceBuilder( Pose2d(-8.7, -63.19, Math.toRadians(180.00)))
                .setReversed(true)
                .splineToLinearHeading(Pose2d(-58.51, -56.23, Math.toRadians(225.00)), Math.toRadians(225.00))
                .setReversed(false)
                .build()

        val sample1: TrajectorySequence =
            drive!!.trajectorySequenceBuilder(Pose2d(-58.51, -56.23, Math.toRadians(45.00)))
                .lineToLinearHeading(Pose2d(-50.5, -42.6,Math.toRadians(90.0)))
                .addTemporalMarker(0.5){outRotationServo!!.position = outRotationCenter}
                .addTemporalMarker(0.5){verticalSlideTo(-30,1.0)}
                .build()
        ...
        val basket2: TrajectorySequence =
            drive!!.trajectorySequenceBuilder(Pose2d(-60.7, -43.3, Math.toRadians(90.00)))
                .setReversed(true)
                .addTemporalMarker(0.5){outRotationServo!!.position = outRotationBackOut}
                .lineToLinearHeading(Pose2d(-56.5, -56.5, Math.toRadians(45.00)))
                .setReversed(false)
        ...
        //BAR
        drive!!.followTrajectorySequence(basket0)
