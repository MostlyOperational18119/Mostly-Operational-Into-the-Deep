...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_Y = -3.6; // Y is the strafe direction

    public static double PERPENDICULAR_X = 2.25;
    public static double PERPENDICULAR_Y = 3.6;

    public static double X_MULTIPLIER = 0.992; // Multiplier in the X direction
    ...
    public TwoWheelTrackingLocalizer(HardwareMap hardwareMap, SampleMecanumDriveCancelable drive) {
        ...
        parallelEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "motorFL"));
        perpendicularEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "motorBL"));
